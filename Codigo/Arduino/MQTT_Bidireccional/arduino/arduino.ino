...
#define WIFI_AP "RedmiNote10S"
#define WIFI_PASSWORD "jolopo09"
...
void sendDataTopic() {
    String payload = "Temperatura: " + String(temperature) + "C, Humedad: " + String(humidity) + "%, Humedad del suelo: " + String(soilMoisture) + ", id_ard: 1";
    char attributes[100];
